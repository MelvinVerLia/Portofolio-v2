...
const ChatDialog = ({ onClose }: ChatDialogProps) => {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent
        className="bg-gray-900 shadow-xl max-w-4xl h-[85vh] flex flex-col p-0"
        style={{
      ...
      >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-gray-300">
                  Ask me anything about Melvin's projects and experience
                </DialogDescription>
              </div>
            </div>
        ...
        {error && (
          <div className="mx-6 mb-2 p-4 bg-gradient-to-r from-red-900/30 to-pink-900/30 border border-red-500/30 rounded-xl backdrop-blur-sm animate-in slide-in-from-top-2">
